...
public class DocumentationEventDeclarationGenImpl extends DocumentationPsiElementImpl implements DocumentationEventDeclaration {

  public DocumentationEventDeclarationGenImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public DocumentationFunctionParameters getFunctionParameters() {
    return findChildByClass(DocumentationFunctionParameters.class);
  }
