...
public class DocumentationUiXmlAttributeItemGenImpl extends DocumentationPsiElementImpl implements DocumentationUiXmlAttributeItem {

  public DocumentationUiXmlAttributeItemGenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DocumentationVisitor visitor) {
    visitor.visitUiXmlAttributeItem(this);
  }
