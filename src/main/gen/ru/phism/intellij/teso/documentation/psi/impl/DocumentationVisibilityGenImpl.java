...
public class DocumentationVisibilityGenImpl extends DocumentationPsiElementImpl implements DocumentationVisibility {

  public DocumentationVisibilityGenImpl(@NotNull ASTNode node) {
    super(node);
  }
