...
public class DocumentationUiXmlTagAttributeGenImpl extends DocumentationPsiElementImpl implements DocumentationUiXmlTagAttribute {

  public DocumentationUiXmlTagAttributeGenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DocumentationVisitor visitor) {
    visitor.visitUiXmlTagAttribute(this);
  }
