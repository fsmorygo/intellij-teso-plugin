...
public class DocumentationFunctionReturnItemGenImpl extends DocumentationPsiElementImpl implements DocumentationFunctionReturnItem {

  public DocumentationFunctionReturnItemGenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DocumentationVisitor visitor) {
    visitor.visitFunctionReturnItem(this);
  }
