...
public class DocumentationVersionSectionGenImpl extends DocumentationPsiElementImpl implements DocumentationVersionSection {

  public DocumentationVersionSectionGenImpl(@NotNull ASTNode node) {
    super(node);
  }
