...
public class DocumentationScriptArgumentDefaultValueGenImpl extends DocumentationPsiElementImpl implements DocumentationScriptArgumentDefaultValue {

  public DocumentationScriptArgumentDefaultValueGenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DocumentationVisitor visitor) {
    visitor.visitScriptArgumentDefaultValue(this);
  }
