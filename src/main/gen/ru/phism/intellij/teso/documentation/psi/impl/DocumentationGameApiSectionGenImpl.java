...
public class DocumentationGameApiSectionGenImpl extends DocumentationPsiElementImpl implements DocumentationGameApiSection {

  public DocumentationGameApiSectionGenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DocumentationVisitor visitor) {
    visitor.visitGameApiSection(this);
  }
