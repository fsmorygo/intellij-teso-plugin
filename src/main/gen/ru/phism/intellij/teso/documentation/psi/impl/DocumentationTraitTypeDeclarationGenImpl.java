...
public class DocumentationTraitTypeDeclarationGenImpl extends DocumentationPsiElementImpl implements DocumentationTraitTypeDeclaration {

  public DocumentationTraitTypeDeclarationGenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DocumentationVisitor visitor) {
    visitor.visitTraitTypeDeclaration(this);
  }
