...
public class DocumentationFunctionParametersGenImpl extends DocumentationPsiElementImpl implements DocumentationFunctionParameters {

  public DocumentationFunctionParametersGenImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public DocumentationFunctionParametersList getFunctionParametersList() {
    return findNotNullChildByClass(DocumentationFunctionParametersList.class);
  }
