...
public class DocumentationSingleTypeDeclarationGenImpl extends DocumentationPsiElementImpl implements DocumentationSingleTypeDeclaration {

  public DocumentationSingleTypeDeclarationGenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DocumentationVisitor visitor) {
    visitor.visitSingleTypeDeclaration(this);
  }
