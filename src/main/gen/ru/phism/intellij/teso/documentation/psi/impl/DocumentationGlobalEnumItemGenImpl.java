...
public class DocumentationGlobalEnumItemGenImpl extends DocumentationPsiElementImpl implements DocumentationGlobalEnumItem {

  public DocumentationGlobalEnumItemGenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DocumentationVisitor visitor) {
    visitor.visitGlobalEnumItem(this);
  }
