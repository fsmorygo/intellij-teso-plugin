...
public class DocumentationTocSettingsGenImpl extends DocumentationPsiElementImpl implements DocumentationTocSettings {

  public DocumentationTocSettingsGenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DocumentationVisitor visitor) {
    visitor.visitTocSettings(this);
  }
