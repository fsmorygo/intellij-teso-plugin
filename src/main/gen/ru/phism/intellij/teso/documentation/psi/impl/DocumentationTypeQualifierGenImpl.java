...
public class DocumentationTypeQualifierGenImpl extends DocumentationPsiElementImpl implements DocumentationTypeQualifier {

  public DocumentationTypeQualifierGenImpl(@NotNull ASTNode node) {
    super(node);
  }
